...
def get_data(txt):
    ...
    # for loc data
    os.path.walk(non_loc_dir, visit, [titles, titles_label, '0', flag]) # for non-loc data
    bounds.append(len(titles))
...
train_file = open('train_ui_pcap_non_ocsvm_new.arff', 'w')
urilist = []
distinct_uri = []
domain_list = []
